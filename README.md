...
### Code
1. Thank you Code institute for providing a beautiful ecommerce site, Boutique Ado, which served as an inspiration and the main source of code for my app.

2. Watching youtube tutorials and Udemy courses gave me some new  idea and showed different coding approaches.

3. Stripe Doc, Dijango Doc - used as a source of my knowledge ans went for terminal commands if I don't remember them.
